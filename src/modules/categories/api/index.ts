...
export const findAllCategoryApi = (data: FindAllParam<FindCategoriesParams>) =>
    request<PageData<Category>>('post', `${settings.API_URL}/categories/find`, data);
...
export const createCategoryApi = (data: ICategoryParams) =>
    request<Category>('post', `${settings.API_URL}/categories`, data);

export const updateCategoryApi = (id: string, data: ICategoryParams) =>
    request<Category>('put', `${settings.API_URL}/categories/${id}`, data);

export const deleteCategoryApi = (id: string) => request<Category>('delete', `${settings.API_URL}/categories/${id}`);

export const getCategoryDetailApi = (id: string, data: FindAllParam<FindCategoriesParams>) =>
    request<Category>('get', `${settings.API_URL}/categories/${id}`, data);
